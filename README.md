...
| **Logic: `cc_new_eden.bsp`** | ⏳ In Progress | Restoring broken triggers, scripts, and overall level logic after decompilation. Nothing works yet. |
| **Graphics: `cc_new_eden.bsp`** | ❌ Not Started | Eliminating obvious, stupid visual bugs (black props, broken shadows). |
| **Light & Depth: `cc_new_eden.bsp`** | ❌ Not Started | Improving lighting, setting up fog, and enhancing room readability. |
